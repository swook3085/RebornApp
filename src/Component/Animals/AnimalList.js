...
export default function AnimalList(props) {
    ...
    return (
        <Animated.FlatList style={{ flex: 1, backgroundColor: '#f4f6fc' }} data={props.data} contentContainerStyle={{ padding: 10 }} 
            ...
            return (
                <TouchableOpacity activeOpacity={1} onPress={() => navigation.navigate('Details', { item, index })} style={{ height: 130,marginBottom: 20}}>
                    <Animated.View style={{ flex: 1, backgroundColor:'#fff',borderRadius: 16, shadowColor:'#000', shadowOffset:{width:0, height:10}, shadowOpacity:.3, shadowRadius:20, elevation: 5, transform:[{scale}], opacity }}>
